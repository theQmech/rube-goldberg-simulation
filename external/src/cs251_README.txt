...
4. Write "cmake ../" on the command prompt to generate a makefile
   Proceed only if no errors.

4a. Write "cmake -DCMAKE_BUILD_TYPE=Debug ../" on the command prompt
   to generate a makefile 
   Proceed only if no errors.

4b. Write "cmake -DCMAKE_BUILD_TYPE=Release ../" on the command prompt
   to generate a makefile 
   Proceed only if no errors.


5. Write "make" on the command prompt
   Proceed only if no errors.

6. Write "make install" on the command prompt.
